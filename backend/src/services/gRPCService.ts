...
import { type StatusRequest, type StatusResponse } from "../types/grpc.js";
...
export class gRPCService{
    ...
    private setupServices():void{
        this.server.addService(
            taskProto.task.TaskService.service,
            {
    ...
    private async handleUpdateTaskStatus(
        ...
        try{
            ...
            callback(null,{ sucess: true, message: `Task ${id} status updated to ${status}`});
        }catch(error){
